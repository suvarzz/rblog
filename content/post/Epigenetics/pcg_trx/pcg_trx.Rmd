...
PcG and TrxG proteins were initially isolated in _Drosophila_ as factors involved in maintaining the expression patterns of HOX genes, which encode transcription factors that are important determinants of patterning.  

# PRC1
PcG proteins form Polycomb repressive complex 1 (PRC1) and Polycomb repressive complex 2 (PRC2). PRC1 ubiquitinylates histone H2AK119 (H2AK118 in Drosophila) and alter chromatin structure whereas PRC2 trimethylates histone H3K27.  
